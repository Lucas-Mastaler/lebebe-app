-- Fase 5A: diferencia anexos iniciais de alterações posteriores de layout.
-- O parâmetro de contabilização é interno e somente o backend service-role o define.

DROP FUNCTION public.registrar_anexo_pedido_personalizado(uuid, uuid, integer, integer, text, text, text, bigint, uuid);
DROP FUNCTION public.substituir_anexo_pedido_personalizado(uuid, uuid, integer, text, text, text, bigint, uuid);
DROP FUNCTION public.remover_anexo_pedido_personalizado(uuid, uuid, integer, uuid);
...
BEGIN
  ...
  IF p_contabilizar_alteracao_layout THEN
    ...
    SET teve_alteracao_layout = true,
        quantidade_alteracoes_layout = COALESCE(quantidade_alteracoes_layout, 0) + 1,
...
REVOKE ALL ON FUNCTION public.registrar_anexo_pedido_personalizado(uuid, uuid, integer, integer, text, text, text, bigint, uuid, boolean) FROM PUBLIC, anon, authenticated;
REVOKE ALL ON FUNCTION public.substituir_anexo_pedido_personalizado(uuid, uuid, integer, text, text, text, bigint, uuid, boolean) FROM PUBLIC, anon, authenticated;
REVOKE ALL ON FUNCTION public.remover_anexo_pedido_personalizado(uuid, uuid, integer, uuid, boolean) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.registrar_anexo_pedido_personalizado(uuid, uuid, integer, integer, text, text, text, bigint, uuid, boolean) TO service_role;
GRANT EXECUTE ON FUNCTION public.substituir_anexo_pedido_personalizado(uuid, uuid, integer, text, text, text, bigint, uuid, boolean) TO service_role;
GRANT EXECUTE ON FUNCTION public.remover_anexo_pedido_personalizado(uuid, uuid, integer, uuid, boolean) TO service_role;
